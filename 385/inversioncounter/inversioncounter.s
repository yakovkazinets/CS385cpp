...
_ZStL19piecewise_construct:
	...
	.text
	.globl	_Z21count_inversions_slowPii
	.type	_Z21count_inversions_slowPii, @function
_Z21count_inversions_slowPii:
.LFB2367:
	.cfi_startproc
	pushq	%rbp
	.cfi_def_cfa_offset 16
...
.L4:
	...
	.cfi_endproc
.LFE2367:
	.size	_Z21count_inversions_slowPii, .-_Z21count_inversions_slowPii
	.globl	_Z21count_inversions_fastPii
	.type	_Z21count_inversions_fastPii, @function
_Z21count_inversions_fastPii:
.LFB2368:
	.cfi_startproc
	pushq	%rbp
	.cfi_def_cfa_offset 16
...
.L13:
	...
	.cfi_endproc
.LFE2368:
	.size	_Z21count_inversions_fastPii, .-_Z21count_inversions_fastPii
	.type	_ZL9mergesortPiS_ii, @function
_ZL9mergesortPiS_ii:
.LFB2369:
	.cfi_startproc
	pushq	%rbp
...
.L17:
	...
	.cfi_endproc
.LFE2369:
	.size	_ZL9mergesortPiS_ii, .-_ZL9mergesortPiS_ii
	.section	.rodata
.LC0:
	.string	"slow"
.LC1:
	.string	"Error: Unrecognized option '"
.LC2:
	.string	"'."
	.align 8
.LC3:
	.string	"Usage: ./inversioncounter [slow]"
	.align 8
.LC4:
	.string	"Enter sequence of integers, each followed by a space: "
.LC5:
	.string	"Error: Non-integer value '"
.LC6:
	.string	"' received at index "
.LC7:
	.string	"."
	.align 8
.LC8:
	.string	"Error: Sequence of integers not received."
.LC9:
	.string	"Number of inversions: "
	.text
	.globl	main
	.type	main, @function
main:
...
.L30:
	...
	movl	$8, %esi
	movq	%rax, %rdi
	call	_ZNSt7__cxx1119basic_istringstreamIcSt11char_traitsIcESaIcEEC1ESt13_Ios_Openmode@PLT
.LEHE0:
	movl	$0, -484(%rbp)
	leaq	-480(%rbp), %rax
	movq	%rax, %rdi
...
.L34:
	...
	movq	%rdx, %rsi
	movq	%rax, %rdi
	call	_ZNSt7__cxx1119basic_istringstreamIcSt11char_traitsIcESaIcEE3strERKNS_12basic_stringIcS2_S3_EE@PLT
	leaq	-488(%rbp), %rdx
	leaq	-416(%rbp), %rax
	movq	%rdx, %rsi
	movq	%rax, %rdi
...
.L44:
	...
	movl	%r12d, %esi
	movq	%rax, %rdi
	call	_Z21count_inversions_slowPii
	movq	%rax, %rsi
	movq	%rbx, %rdi
	call	_ZNSolsEl@PLT
	movq	%rax, %rdx
...
.L45:
	...
	movl	%r12d, %esi
	movq	%rax, %rdi
	call	_Z21count_inversions_fastPii
	movq	%rax, %rsi
	movq	%rbx, %rdi
	call	_ZNSolsEl@PLT
	movq	%rax, %rdx
...
.LLSDACSB2370:
	.uleb128 .LEHB0-.LFB2370
	.uleb128 .LEHE0-.LEHB0
	.uleb128 0
	.uleb128 0
	.uleb128 .LEHB1-.LFB2370
	.uleb128 .LEHE1-.LEHB1
	.uleb128 .L50-.LFB2370
	.uleb128 0
	.uleb128 .LEHB2-.LFB2370
	.uleb128 .LEHE2-.LEHB2
	.uleb128 0
	.uleb128 0
.LLSDACSE2370:
...
.LFE2994:
	...
	.type	_GLOBAL__sub_I__Z21count_inversions_slowPii, @function
_GLOBAL__sub_I__Z21count_inversions_slowPii:
.LFB2995:
	.cfi_startproc
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	.cfi_endproc
.LFE2995:
	.size	_GLOBAL__sub_I__Z21count_inversions_slowPii, .-_GLOBAL__sub_I__Z21count_inversions_slowPii
	.section	.init_array,"aw"
	.align 8
	.quad	_GLOBAL__sub_I__Z21count_inversions_slowPii
